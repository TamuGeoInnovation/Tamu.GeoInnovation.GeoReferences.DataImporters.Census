...
{
    public abstract class AbstractTiger2008ShapefileCountryFileLayout : AbstractTiger2008CountryFileLayout
    {
        ...
        public AbstractTiger2008ShapefileCountryFileLayout()
            : base() { }

        public AbstractTiger2008ShapefileCountryFileLayout(string tableName)
            : base(tableName) { }
