...
{
    public abstract class AbstractTiger2010ShapefileCountyFileLayout : AbstractTiger2010CountyFileLayout
    {
        #region Events
        ...
        public AbstractTiger2010ShapefileCountyFileLayout(string tableName)
            : base(tableName) { }
