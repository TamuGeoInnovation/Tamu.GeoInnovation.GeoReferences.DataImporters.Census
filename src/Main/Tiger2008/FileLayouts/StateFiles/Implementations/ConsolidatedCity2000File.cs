...
{
    public class ConsolidatedCity2000File : AbstractTiger2010ShapefileStateFileLayout
    {

        public ConsolidatedCity2000File(string stateName)
            : base(stateName)
        {

            FileName = "concity00.zip";
            ...
            SQLCreateTable += "conctyFp00 varchar(5) DEFAULT NULL,";
            SQLCreateTable += "cCtyIdFp00 varchar(7) DEFAULT NULL,";
            ...
            SQLCreateTable += "PRIMARY KEY  (conctyFp00)";
            SQLCreateTable += ");";
