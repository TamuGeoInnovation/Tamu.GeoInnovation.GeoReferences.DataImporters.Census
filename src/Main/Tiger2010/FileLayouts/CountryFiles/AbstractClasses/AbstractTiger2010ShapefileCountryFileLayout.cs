...
namespace USC.GISResearchLab.Common.Census.Tiger2010.FileLayouts.CountryFiles.AbstractClasses
{
    public abstract class AbstractTiger2010ShapefileCountryFileLayout : AbstractTiger2010CountryFileLayout
    {
        ...
        public AbstractTiger2010ShapefileCountryFileLayout()
            : base() { }

        public AbstractTiger2010ShapefileCountryFileLayout(string tableName)
            : base(tableName) { }
