...
{
    public abstract class AbstractTiger1990ShapefileStateFileLayout : AbstractTiger1990StateFileLayout
    {
        ...
        public AbstractTiger1990ShapefileStateFileLayout(string tableName)
            : base(tableName) { }
