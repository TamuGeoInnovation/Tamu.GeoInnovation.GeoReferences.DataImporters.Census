...
namespace USC.GISResearchLab.Common.Census.Tiger2010.FileLayouts.AbstractClasses
{
    public abstract class AbstractTiger2010FileLayout : ITigerFileLayout
    {
        ...
        public AbstractTiger2010FileLayout()
        {
        ...
        public AbstractTiger2010FileLayout(string tableName)
            : this()
        {
            StateName = tableName;
        }
