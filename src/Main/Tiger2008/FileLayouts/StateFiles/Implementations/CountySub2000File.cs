...
{
    public class CountySub2000File : AbstractTiger2010ShapefileStateFileLayout
    {

        public CountySub2000File(string stateName)
            : base(stateName)
        {

            FileName = "cousub00.zip";
            ...
            SQLCreateTable += "cousubFp00 varchar(5) DEFAULT NULL,";
            SQLCreateTable += "cosbIdFp00 varchar(10) DEFAULT NULL,";
            ...
            SQLCreateTable += "CONSTRAINT [PK_" + OutputTableName + "_cousubFp00] PRIMARY KEY CLUSTERED ([cousubFp00] ASC )WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = ON, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]";
            SQLCreateTable += ");";
