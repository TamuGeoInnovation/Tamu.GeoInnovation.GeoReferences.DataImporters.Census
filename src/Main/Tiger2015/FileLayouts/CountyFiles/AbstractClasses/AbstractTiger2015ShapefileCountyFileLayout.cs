...
{
    public abstract class AbstractTiger2015ShapefileCountyFileLayout : AbstractTiger2015CountyFileLayout
    {
        #region Events
        ...
        public AbstractTiger2015ShapefileCountyFileLayout(string tableName)
            : base(tableName) { }
