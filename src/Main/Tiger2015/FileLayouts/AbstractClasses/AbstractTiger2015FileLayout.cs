...
{
    public abstract class AbstractTiger2015FileLayout: ITigerFileLayout
    {
        ...
        public AbstractTiger2015FileLayout()
        {
        ...
        public AbstractTiger2015FileLayout(string tableName)
            : this()
        {
            StateName = tableName;
        }
