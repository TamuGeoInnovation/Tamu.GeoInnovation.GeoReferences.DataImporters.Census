...
{
    public class ConsolidatedCity2008File : AbstractTiger2008ShapefileStateFileLayout
    {

        public ConsolidatedCity2008File(string stateName)
            : base(stateName)
        {

            FileName = "concity.zip";
            ...
            SQLCreateTable += "conctyFp varchar(5) DEFAULT NULL,";
            SQLCreateTable += "conctyNs varchar(8) DEFAULT NULL,";
            SQLCreateTable += "cCtyIdFp varchar(7) DEFAULT NULL,";
            ...
            SQLCreateTable += "PRIMARY KEY  (conctyFp)";
            SQLCreateTable += ");";
