...
{
    public class Tiger2010AddressRangesFile : AbstractTiger2010CountyFileLayout
    {
        public Tiger2010AddressRangesFile(string stateName)
            : base(stateName)
        {
        ...
        {
            Tiger2010AddressRangesFileDataReader ret = null;

            try
            {
                ret = new Tiger2010AddressRangesFileDataReader(fileLocation);
                ret.NotifyAfter = 10;
