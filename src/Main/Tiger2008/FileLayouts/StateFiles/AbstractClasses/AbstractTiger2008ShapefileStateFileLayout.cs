...
{
    public abstract class AbstractTiger2008ShapefileStateFileLayout : AbstractTiger2008StateFileLayout
    {
        ...
        public AbstractTiger2008ShapefileStateFileLayout(string tableName)
            : base(tableName) { }
