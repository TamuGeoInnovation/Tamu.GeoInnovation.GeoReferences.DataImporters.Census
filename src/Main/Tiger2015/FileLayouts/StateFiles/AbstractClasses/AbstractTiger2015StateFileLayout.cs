...
{
    public abstract class AbstractTiger2015StateFileLayout: AbstractTiger2015FileLayout
    {

        public AbstractTiger2015StateFileLayout(string tableName)
            : base(tableName) { }
        ...
        public override DataTable GetDataTableFromZipFile(string zipFileDirectory)
        {
            ...
            try
            {
                ...
                string zipFileName = "tl_2015_" + stateFips + "_" + FileName;
