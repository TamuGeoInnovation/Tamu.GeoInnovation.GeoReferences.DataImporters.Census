...
{
    public class Tiger2015EdgesFile : AbstractTiger2015ShapefileCountyFileLayout
    {

        public Tiger2015EdgesFile(string stateName, bool shouldDoOnlyStreets, bool shouldDoOnlyNamedStreets)
            : base(stateName)
        {
