...
{
    public abstract class AbstractTiger2015ShapefileCountryFileLayout : AbstractTiger2015CountryFileLayout
    {
        ...
        public AbstractTiger2015ShapefileCountryFileLayout()
            : base() { }

        public AbstractTiger2015ShapefileCountryFileLayout(string tableName)
            : base(tableName) { }
