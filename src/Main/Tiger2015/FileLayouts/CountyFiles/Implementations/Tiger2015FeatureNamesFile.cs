...
{
    public class Tiger2015FeatureNamesFile : AbstractTiger2015CountyFileLayout
    {
        public Tiger2015FeatureNamesFile(string stateName)
            : base(stateName)
        {
            ...
            SQLCreateTableIndexes += " IF  NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[" + OutputTableName + "]') AND name = N'IDX_" + OutputTableName + "_name_Soundex' )";
            ...
            SQLCreateTableIndexes += " IF  NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[" + OutputTableName + "]') AND name = N'IDX_" + OutputTableName + "_name' )";
